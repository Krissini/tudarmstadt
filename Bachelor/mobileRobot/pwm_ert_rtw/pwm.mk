###########################################################################
## Makefile generated for Simulink model 'pwm'. 
## 
## Makefile     : pwm.mk
## Generated on : Sat Jun 02 15:47:01 2018
##  version:  
## 
## Build Info:
## 
...
MODELREF_LINK_RSPFILE_NAME = pwm_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/pwm.elf
...
DEFINES_ = -DMODEL=pwm -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DONESTEPFCN=1 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DARM_PROJECT -D_USE_TARGET_UDP_ -D_RUNONTARGETHARDWARE_BUILD_ -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT
...
SRCS = MW_gpio.c MW_led.c pwm.c pwm_data.c linuxinitialize.c
...
OBJS = MW_gpio.c.o MW_led.c.o pwm.c.o pwm_data.c.o linuxinitialize.c.o
