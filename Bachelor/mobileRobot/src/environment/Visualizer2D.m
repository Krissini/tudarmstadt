classdef Visualizer2D < matlab.System & matlab.system.mixin.CustomIcon
    ...
    %
    % Displays the pose (position and orientation) or an object in a 2D
    ...
    methods(Access = protected)
        ...
        function setupImpl(obj)
            ...
            if ~isempty(obj.mapName)
                obj.map = evalin('base',obj.mapName);
                if isa(obj.map,'robotics.OccupancyGrid') || isa(obj.map,'robotics.BinaryOccupancyGrid')
            ...
            obj.RobotHandle = plot(obj.ax,0,0,'bo','LineWidth',1.5, ... 
