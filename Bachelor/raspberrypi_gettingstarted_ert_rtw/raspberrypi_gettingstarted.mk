...
## Generated on : Mon May 28 23:05:05 2018
##  version:  
## 
## Build Info:
## 
...
MODELREF_LINK_RSPFILE_NAME = raspberrypi_gettingstarted_ref.rsp
...
DEFINES_ = -DMODEL=raspberrypi_gettingstarted -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DONESTEPFCN=1 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DARM_PROJECT -D_USE_TARGET_UDP_ -D_RUNONTARGETHARDWARE_BUILD_ -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT
...
SRCS = MW_led.c raspberrypi_gettingstarted.c raspberrypi_gettingstarted_data.c linuxinitialize.c
...
OBJS = MW_led.c.o raspberrypi_gettingstarted.c.o raspberrypi_gettingstarted_data.c.o linuxinitialize.c.o
